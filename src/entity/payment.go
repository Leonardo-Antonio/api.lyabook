...
type (
	ProductPayment struct {
		...
		Importe     float32            `bson:"importe,omitempty" json:"importe,omitempty" xml:"importe,omitempty"`
	}
	...
	PaymentClient struct {
		...
		TotalPagar     float32            `bson:"total_pagar,omitempty" json:"total_pagar,omitempty" xml:"total_pagar,omitempty"`
		CreateAt       time.Time          `json:"created_at,omitempty" bson:"created_at,omitempty" xml:"created_at,omitempty"`
		CreateAtString string             `json:"created_at-parse,omitempty" bson:"created_at-parse,omitempty" xml:"created_at-parse,omitempty"`
