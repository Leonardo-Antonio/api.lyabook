...
type Book struct {
	...
	Type         []Format           `bson:"type,omitempty" json:"type,omitempty" xml:"type,omitempty" validmor:"required"`
	Categories   []Category         `bson:"categories,omitempty" json:"categories,omitempty" xml:"categories,omitempty" validmor:"required"`
