                        ...
                        <tbody align="center">
                            <tr align="center">
                                <td align="center">
                                    <div>
                                        <a href="{{ .Link }}"
                                            style="display: flex; justify-content: center; align-items: center; text-decoration: none;background-color: #021639; height: 2.5rem; border-radius: 999px; color: #fff; font-family: 'Baloo Chettan 2'; font-weight: 600; width: 100%;">Validar</a>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
